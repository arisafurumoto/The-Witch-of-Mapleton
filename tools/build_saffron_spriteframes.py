...
BASE_RES = "res://art/characters/saffron"
BASE_FS = os.path.join(PROJECT, "art/characters/saffron")
WALK_SUBDIR = "animations/walking_with_an_expressive_tail"
OUT = os.path.join(BASE_FS, "Saffron.tres")
WALK_FRAMES = 9
...
print("Wrote", OUT, "| textures:", len(ext_id_by_path), "animations:", len(animations), "load_steps:", load_steps)
