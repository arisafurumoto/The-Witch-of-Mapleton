...
BASE_RES = "res://art/characters/npcs/generic_customer"
BASE_FS = os.path.join(PROJECT, "art/characters/npcs/generic_customer")
WALK_SUBDIR = "animations/Walking"
OUT = os.path.join(BASE_FS, "GenericCustomer.tres")
WALK_FRAMES = 8
...
def ext_id(res_path):
    if res_path not in ext_id_by_path:
        ...
        ext_lines.append(
            f'[ext_resource type="Texture2D" path="{res_path}" id="{rid}"]'
        )
